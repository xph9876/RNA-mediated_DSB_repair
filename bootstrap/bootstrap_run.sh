...
python bootstrap.py input/yeast.tsv output_diff/yeast.xlsx -draw output_diff/yeast -ca SPT3 -cb RHSPT3 -na Antisense -nb BranchD -stat diff
...
python bootstrap.py input/yeast.tsv output_ratio/yeast.xlsx -draw output_ratio/yeast -ca SPT3 -cb RHSPT3 -na Antisense -nb BranchD -stat ratio