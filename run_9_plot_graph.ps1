python 2_graph_processing/plot_graph.py -i libraries_4/WT_sgAB_R1_sense -o plots/graphs/individual/png --layout_dir layouts/2DSB_R1 -ext png --layout radial
...
python 2_graph_processing/plot_graph.py -i libraries_4/WT_sgCD_R2_splicing -o plots/graphs/individual/png --layout_dir layouts/2DSBanti_R2 -ext png --layout radial