...
DSB_TYPE_2yeast = '2DSByeast'
DSB_TYPES = [DSB_TYPE_1, DSB_TYPE_2, DSB_TYPE_2anti, DSB_TYPE_2yeast]
...
CELL_LINE_KO = 'KO'
CELL_LINE_YWT = 'YWT'
CELL_LINE_YWTS3 = 'YWTS3'
CELL_LINE_YRNS3 = 'YRNS3'
CELL_LINES = [
  CELL_LINE_WT,
  CELL_LINE_KO,
  CELL_LINE_YWT,
...
CONSTRUCT_ANTISENSE_BRANCH = CONSTRUCT_ANTISENSE + '_' + CONSTRUCT_BRANCH
...
CONSTRUCTS_COMPARISON_YEAST = [
  CONSTRUCT_ANTISENSE_BRANCH
]
...
LABELS = {
  ...
  'antisense_branch': 'Antisense & Branch∆',
  'noDSB': 'No-DSB',
  '30bpDown': '30 bp Down',
  'notControl': '',
