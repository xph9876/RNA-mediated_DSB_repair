...
python 2_graph_processing/make_main_data.py -i libraries_3_old/WT_sgCD_R1_antisense.tsv -o libraries_4_old/WT_sgCD_R1_antisense -ref ref_seq/2DSBanti_R1_antisense.fa -dsb 50 --dsb_type 2a --strand R1 --hguide CD --cell WT --treatment antisense --subst_type without --control none
python 2_graph_processing/make_main_data.py -i libraries_3_old/WT_sgCD_R1_splicing.tsv -o libraries_4_old/WT_sgCD_R1_splicing -ref ref_seq/2DSBanti_R1_splicing.fa -dsb 50 --dsb_type 2a --strand R1 --hguide CD --cell WT --treatment splicing --subst_type without --control none
python 2_graph_processing/make_main_data.py -i libraries_3_old/WT_sgCD_R2_antisense.tsv -o libraries_4_old/WT_sgCD_R2_antisense -ref ref_seq/2DSBanti_R2_antisense.fa -dsb 47 --dsb_type 2a --strand R2 --hguide CD --cell WT --treatment antisense --subst_type without --control none
python 2_graph_processing/make_main_data.py -i libraries_3_old/WT_sgCD_R2_splicing.tsv -o libraries_4_old/WT_sgCD_R2_splicing -ref ref_seq/2DSBanti_R2_splicing.fa -dsb 47 --dsb_type 2a --strand R2 --hguide CD --cell WT --treatment splicing --subst_type without --control none

:: 03_make_main_data_withSubst
python 2_graph_processing/make_main_data.py -i libraries_3_old/WT_sgCD_R1_antisense.tsv -o libraries_4_old/WT_sgCD_R1_antisense -ref ref_seq/2DSBanti_R1_antisense.fa -dsb 50 --dsb_type 2a --strand R1 --hguide CD --cell WT --treatment antisense --subst_type with --control none
python 2_graph_processing/make_main_data.py -i libraries_3_old/WT_sgCD_R1_splicing.tsv -o libraries_4_old/WT_sgCD_R1_splicing -ref ref_seq/2DSBanti_R1_splicing.fa -dsb 50 --dsb_type 2a --strand R1 --hguide CD --cell WT --treatment splicing --subst_type with --control none
python 2_graph_processing/make_main_data.py -i libraries_3_old/WT_sgCD_R2_antisense.tsv -o libraries_4_old/WT_sgCD_R2_antisense -ref ref_seq/2DSBanti_R2_antisense.fa -dsb 47 --dsb_type 2a --strand R2 --hguide CD --cell WT --treatment antisense --subst_type with --control none
python 2_graph_processing/make_main_data.py -i libraries_3_old/WT_sgCD_R2_splicing.tsv -o libraries_4_old/WT_sgCD_R2_splicing -ref ref_seq/2DSBanti_R2_splicing.fa -dsb 47 --dsb_type 2a --strand R2 --hguide CD --cell WT --treatment splicing --subst_type with --control none
