python 2_graph_processing/make_histogram_3d.py -i libraries_4/WT_sgAB_R1_sense -o plots/histogram_3d/ -lt relative
...
python 2_graph_processing/make_histogram_3d.py -i libraries_4/KO_sgB_R2_cmv_nodsb -o plots/histogram_3d/ -rp  -lt relative