python 2_graph_processing/plot_graph.py -i libraries_4/WT_sgAB_R1_sense -o plots/graphs/individual/png --layout_dir layouts/2DSB_AB -ext png --layout radial
...
python 2_graph_processing/plot_graph.py -i libraries_4/WT_sgCD_R2_splicing -o plots/graphs/individual/png --layout_dir layouts/2DSBanti_CD -ext png --layout radial --reverse_complement

python 2_graph_processing/plot_graph.py -i libraries_4/WT_sgAB_R1_sense_branch -o plots/graphs/combined/png --layout_dir layouts/2DSB_AB -ext png --layout radial
...
python 2_graph_processing/plot_graph.py -i libraries_4/WT_sgCD_R2_antisense_splicing -o plots/graphs/combined/png --layout_dir layouts/2DSBanti_CD -ext png --layout radial --reverse_complement 
