...
python 2_graph_processing/make_main_data.py -i libraries_3_old/WT_sgCD_R1_antisense.tsv -o libraries_4_old/WT_sgCD_R1_antisense -ref ref_seq/2DSBanti_R1_antisense.fa -dsb 66 --dsb_type 2a --strand R1 --hguide CD --cell WT --treatment antisense --subst_type without --control none
python 2_graph_processing/make_main_data.py -i libraries_3_old/WT_sgCD_R1_splicing.tsv -o libraries_4_old/WT_sgCD_R1_splicing -ref ref_seq/2DSBanti_R1_splicing.fa -dsb 66 --dsb_type 2a --strand R1 --hguide CD --cell WT --treatment splicing --subst_type without --control none
...
python 2_graph_processing/make_main_data.py -i libraries_3_old/WT_sgCD_R1_antisense.tsv -o libraries_4_old/WT_sgCD_R1_antisense -ref ref_seq/2DSBanti_R1_antisense.fa -dsb 66 --dsb_type 2a --strand R1 --hguide CD --cell WT --treatment antisense --subst_type with --control none
python 2_graph_processing/make_main_data.py -i libraries_3_old/WT_sgCD_R1_splicing.tsv -o libraries_4_old/WT_sgCD_R1_splicing -ref ref_seq/2DSBanti_R1_splicing.fa -dsb 66 --dsb_type 2a --strand R1 --hguide CD --cell WT --treatment splicing --subst_type with --control none
